...
## Peter Drucker — Management et finalité
```yaml
...
## Seth Godin — Marketing et tribus
```yaml
...
## Donella Meadows — Pensée systémique
```yaml
...
## Jean-luc Doumont — Communication structurée
```yaml
